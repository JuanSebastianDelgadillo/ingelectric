<div class="container-fluid">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo base_url(); ?>assets/img/carrusel/3.png" alt="Third slide">
        <div class="carousel-caption d-none d-md-block" id="caption-portada">
          <h2>AUTOMATIZACIÓN Y CONTROL INDUSTRIAL</h2>
          <p>Manejo de proyectos de de automatización y control industrial</p>
        </div>
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo base_url(); ?>assets/img/carrusel/4.png" alt="fourth slide">
        <div class="carousel-caption d-none d-md-block" id="caption-portada">
          <h2>IMPLEMENTACIÓN DE CORRIENTES DÉBILES</h2>
          <p>Planos, certificación e instalación de corrientes débiles, en empresas, galpones y casas.</p>
        </div>
      </div>
      <div class="carousel-item">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo base_url(); ?>assets/img/carrusel/6.png" alt="sixth slide">
        <div class="carousel-caption d-none d-md-block" id="caption-portada">
          <h2>SERVICIOS DE MANTENCIÓN INDUSTRIAL</h2>
          <p>Servicio de mantenimiento de maquinaria y equipos industriales.</p>
        </div>
      </div>
      <div class="carousel-item">
